...
String baseUrl = "https://string-cz7x.onrender.com"; // BASE URL
...
String getUserChatsRoute = "/api/chat/getusers"; // GET USER CHATS ROUTE

String createChatRoute = "/api/chat/create"; // CREATE CHAT

String getSingleUserChatRoute = "/api/chat/get/63a787be0eb086fcc3a142bd"; // GET SINGLE USER CHAT ROUTE

String getBothUserChatRoute = "/api/chat/find/63a787be0eb086fcc3a142bd/63b1c752e39fdd3a75126ff9"; // GET SINGLE USER CHAT ROUTE

String createMessageRoute = "/api/message/create"; // CREATE MESSAGE ROUTE

String getMessagesROute = "/api/message/get/"; // GET MESSAGES ROUTE
